    ...
    <>
      ...
      >
        <div className="hero__main grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4  lg:gap-5 xl:gap-[30px]">
          <div className="hero__text font-primary leading-[61px] lg:col-span-2 self-end">
          ...
          <div className=" overflow-hidden md:mr-8 xl:mr-0">
            <img
              src={hero1}
              alt=""
          ...
          <div className="overflow-hidden md:ml-8 lg:ml-0  md:col-start-1 md:col-end-2 lg:col-start-2 lg:col-end-3">
            <img
              src={hero1}
              alt=""
